...
require_once "approve_payment_process.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
									...
									<div class="" style="width: 100%;max-width: 85%;display: block;margin: 0 auto">
										<div class="col-md-offset-2 col-md-9 col-sm-12 col-xs-12">
											<div class="mb60  section-title text-center  ">
												<!-- section title start-->
												<h1><b>Approve/Disapprove Wallet Payments</b></h1>
											</div>
											<?php if (!empty($errors)): ?>
										...
										<input id="action" name="action" type="hidden" value="<?php echo !empty($action)?$action:'' ?>" />
										<!-- Text input-->
										...
										<div class="col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<input id="amount" name="amount" type="text" placeholder="" class="form-control input-md <?php echo !empty($errors['amount'])?'error':'' ?>" value="<?php echo !empty($amount)?strtoupper($amount):0 ?>" >
										...
										<div class="col-md-12 col-xs-12 text-center submit_btn_holder">
											<button type="submit" id="submit_reg_form" class="btn btn-default site_default_btn"  style=""><b><?php echo (!empty($action) && strtolower($action)==="approve")?'APPROVE':'DISAPPROVE' ?></b></button>
										</div>
									</div>
								</form>
							</div>
