...
<head>
	...
	<title>Online Student Registration System | <?php echo !empty($id)?' Update':' Add New'; ?> Student</title>
				...
				<div class="wrapper-content bg-white pinside40">
                              <div class="form-group top_right_btn">
                                    <div class="col-xs-12 text-right">
                                          <a href="admin_students/" class="site_default_btn_small">View Students</a>
                                    </div>
                              </div>
									...
									<div class="" style="width: 100%;max-width: 85%;display: block;margin: 0 auto">
										<div class="col-md-offset-2 col-md-9 col-sm-12 col-xs-12">
											<div class="mb60  section-title text-center  ">
												<!-- section title start-->
												<h1><b><?php echo !empty($id)?' Update':' Add New'; ?> Student</b></h1>
										...
										<div class="col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<?php if(!empty($errors['lga'])){echo '<p class="help-block">'.$errors['lga'].'</p>'; } ?>
                                                            ...
                                                            <div class="col-xs-12">
                                                                  <div class="form-group ">
                                                                        <label class="field_label" for="study_centre">Study Centre <span style="color:red">*</span><span class=" "> </span></label>
                                                                        <input id="study_centre" name="study_centre" type="text" placeholder="" class="form-control input-md <?php echo !empty($errors['study_centre'])?'error':'' ?>" value="<?php echo !empty($study_centre)?$study_centre:'' ?>" >
												<?php if(!empty($errors['study_centre'])){echo '<p class="help-block">'.$errors['study_centre'].'</p>'; } ?>
                                                                        <small>e.g Port Harcourt Study Centre, Abuja Study Centre, etc.</small>
                                                                  </div>
                                                            </div>
                                                            <div style="clear: both"></div>
                                                            <div class="col-sm-6 col-xs-12">
