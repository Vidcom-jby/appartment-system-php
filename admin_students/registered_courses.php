<?php
session_start();
if(!empty($_SESSION['user']) && !empty($_SESSION['user']['user_group']) && strtolower($_SESSION['user']['user_group']) !=="administrator") {
			...
			<div class="col-md-12">
				<div class="wrapper-content bg-white pinside40">
					...
					<div class="form-group registered_detail">
						<div class="col-xs-12">
							<div class="  text-center">
								<div class="s_logo2"><img src="<?php echo (!empty($student_data) && !empty($student_data['image']))?$student_data['image']:'' ?>"/> </div>
								<div>
								<b><?php echo (!empty($student_data) && !empty($student_data['surname']))?ucwords($student_data['surname']):'' ?></b>
								<b><?php echo (!empty($student_data) && !empty($student_data['other_name']))?ucwords($student_data['other_name']):'' ?></b><br/>
								<b><?php echo (!empty($student_data) && !empty($student_data['matric_number']))?strtoupper($student_data['matric_number']):'' ?></b><br />
								</div>
							</div>
						</div>
					</div>
									...
									<div class="" style="width: 100%;max-width: 85%;display: block;margin: 0 auto">
											...
											<div class="col-xs-12">
												<div class="form-group">
													<div class="text-center alert alert-danger" style="width: 100%">
														<p>This Student have no Registered Courses Available.</p>
													</div><br/>
												</div>
											</div>
										<?php else: ?>
										...
										<?php if(empty($exam_details)): ?>
											<div class="col-xs-12">
												<div class="form-group">
													<div class="text-center alert alert-danger" style="width: 100%">
														<p>This Student have no Registered Exams Courses Available.</p>
													</div><br/>
												</div>
											</div>
										<?php else: ?>
