...
<head>
	...
	<title>Online Student Registration System | Wallet Payments</title>
									...
									<div class="" style="width: 100%;max-width: 100%;display: block;margin: 0 auto">
										<div class="col-sm-12 col-xs-12">
											<div class="mb60  section-title text-center  ">
												...
												<p>The following are List of Your Wallet Payments</p>
											</div>
										</div>
										...
										<div class="col-xs-12">
											<table id="dept_list_data_table" class="table  responsive nowrap table-bordered" cellspacing="0" width="100%">
												...
												<tr>
													...
													<?php if(!empty($_SESSION['user']['user_group']) && $_SESSION['user']['user_group']===strtoupper('cashier')): ?>
												...
												<?php while($dept_list = $stmt->fetch(PDO::FETCH_ASSOC)){ ?>
													<tr>
														...
														<?php if(!empty($_SESSION['user']['user_group']) && $_SESSION['user']['user_group']===strtoupper('cashier')): ?>
															<td  class="text-center" style="vertical-align: middle">
																<a data-location_url="cashier/approve_payment.php?id=<?php echo !empty($dept_list['id'])?$dept_list['id']:'' ?>" data-message="Are you sure you want to Approve this Payment?" data-toggle="tooltip" title="Approve this Payment of (#<?php echo !empty($dept_list['amount'])?number_format(floatval($dept_list['amount']),2,'.',','):0.00 ?>)" href="javascript:;" class="btn btn-danger modal_action_btn"><i class="fas fa-trash"></i></a>
															</td>
														<?php endif; ?>
													</tr>
												<?php } ?>
