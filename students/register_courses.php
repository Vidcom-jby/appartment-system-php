...
require_once "register_courses_process.php";
...
<head>
	...
	<title>Online Student Registration System | Register Courses</title>
									...
									<div class="" style="width: 100%;max-width: 85%;display: block;margin: 0 auto">
										<div class="col-md-offset-2 col-md-9 col-sm-12 col-xs-12">
                                                                  ...
                                                                  <div class="col-xs-12">
                                                                        <div class="form-group">
                                                                              <div class="text-center alert alert-danger" style="width: 100%">
                                                                                    <p>You have already Registered all Available  Courses in your Department and Level.</p>
                                                                              </div><br/>
                                                                        </div>
                                                                  </div>
                                                                  <?php else: ?>
